...
public class HabitList extends Activity implements HabitEntryListener, LoaderCallbacks<Cursor> {
	...
	private void setUpListViewAndAdapter() {
		...
		mAdapter = new SimpleCursorAdapter(this, R.layout.habit_list_item, null, columns, new int[] { R.id.textView_habit_list_name,
				R.id.textView_habit_list_goal }, 0);
		...
		mAdapter.setViewBinder(new ViewBinder() {
			...
			private void setStatistics(RelativeLayout parent) {
				...
				/*
				 * Create the hashmap table first with HISTORY_LENGTH entries to
				 * be sure
				 */
